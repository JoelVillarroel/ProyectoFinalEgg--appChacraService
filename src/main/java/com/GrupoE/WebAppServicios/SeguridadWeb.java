    ...
    protected void configure(HttpSecurity http)throws Exception{
        http
                .authorizeRequests()
                    ...
                    .permitAll()
                    .antMatchers("/inicio","/proveedor/**","/trabajo/**","/imagen/**","/perfilUser/**","/perfilProveedor/**","/actualizarUser/**", "/perfil/actualizarProveedor/**","/actualizarProveedor/**" ).hasAnyRole("USER","ADMIN", "PROVEEDOR") // Permite el acceso a /inicio solo si el usuario tiene el rol USER, ADMIN o PROVEEDOR
