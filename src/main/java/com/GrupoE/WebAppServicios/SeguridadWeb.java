    ...
    protected void configure(HttpSecurity http)throws Exception{
        http
                .authorizeRequests()
                    ...
                    .permitAll()
                    .antMatchers("/inicio","/proveedor/**","/trabajo/**","/imagen/**","/perfil/**","/actualizarUser/**", "/actualizarProveedor/**").hasAnyRole("USER","ADMIN", "PROVEEDOR") // Permite el acceso a /inicio solo si el usuario tiene el rol USER, ADMIN o PROVEEDOR
